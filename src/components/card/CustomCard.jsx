 ...
 * @param {node} overlaySlot - 미디어 영역 위에 표시할 오버레이 요소 [Optional]
 ...
 * @param {string} gap - 미디어와 콘텐츠 사이 간격 ('none' | 'xs' | 'sm' | 'md' | 'lg') [Optional, 기본값: 'none']
 * @param {number} hoverLift - hover 시 위로 들리는 px 값 [Optional]
 * @param {string} hoverBorderColor - hover 시 border 색상 [Optional]
 * @param {string} hoverBgColor - hover 시 배경색 [Optional]
 * @param {number} hoverMediaScale - hover 시 미디어 확대 비율 [Optional]
 *
 * Example usage:
 * <CustomCard
 *   layout="horizontal"
